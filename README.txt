...
This document describes how to copy and customise the unitecstandard_base (bootstrapbase) theme so that
...
From your Moodle theme directory right click on unitecstandard_base and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of unitecstandard_base.
...
underscores. For the purpose of this tutorial we will call the theme 'unitecstandard_basetheme'.

On opening 'unitecstandard_basetheme' your you will find several files and sub-directories which have
files within them.
...
/lang/en/theme_unitecstandard_base.php
...
where the old theme name occurs, in this case unitecstandard_base. So using the above list as
a guide, search through and change all the instances of the theme name
'unitecstandard_base' to 'unitecstandard_basetheme'. This includes the filename of the lang/en/theme_unitecstandard_base.php.
You need to change this to 'theme_unitecstandard_basetheme.php'.
...
and then click on (unitecstandard_basetheme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the unitecstandard_base theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > unitecstandard_base

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/unitecstandard_base_theme
