...
if ($ADMIN->fulltree) {
    ...
    $description = get_string('customcssdesc', 'theme_unitecstandard_base');
    $default = '';
    ...
    // Footnote setting.
    $name = 'theme_unitecstandard_base/footnote';
    $title = get_string('footnote', 'theme_unitecstandard_base');
    $description = get_string('footnotedesc', 'theme_unitecstandard_base');
    $default = '';
